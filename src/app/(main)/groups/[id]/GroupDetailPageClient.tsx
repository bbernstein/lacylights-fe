...
import { extractGroupId } from '@/utils/routeUtils';

interface GroupDetailPageClientProps {
  groupId: string;
}

export default function GroupDetailPageClient({ groupId: groupIdProp }: GroupDetailPageClientProps) {
  const groupId = extractGroupId(groupIdProp);
