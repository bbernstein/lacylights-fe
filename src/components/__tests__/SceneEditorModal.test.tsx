...
import { ChannelType, FixtureType, FadeBehavior } from '../../types';
import {
  GET_SCENE,
  UPDATE_SCENE,
...
describe('SceneEditorModal', () => {
  ...
  describe('form submission', () => {
    ...
    it('shows loading state during save', async () => {
      ...
      renderWithProvider(delayedMocks as any); // eslint-disable-line @typescript-eslint/no-explicit-any
  ...
  describe('edge cases', () => {
    it('handles scene without fixtures', async () => {
      ...
      renderWithProvider(mocks as any); // eslint-disable-line @typescript-eslint/no-explicit-any
    ...
    it('handles fixtures without color channels', async () => {
      const fixtureWithoutColor = {
        ...mockFixtures[0],
        channels: [
          { id: 'ch-1', offset: 0, name: 'Intensity', type: ChannelType.INTENSITY, minValue: 0, maxValue: 255, defaultValue: 255, fadeBehavior: FadeBehavior.FADE, isDiscrete: false },
        ],
      };
