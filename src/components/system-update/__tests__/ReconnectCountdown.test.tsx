...
describe('ReconnectCountdown', () => {
  describe('renders countdown timer', () => {
    it('displays the countdown number', () => {
      render(<ReconnectCountdown countdown={45} maxSeconds={90} />);
      expect(screen.getByText('45')).toBeInTheDocument();
    });

    it('displays seconds label', () => {
      render(<ReconnectCountdown countdown={30} maxSeconds={60} />);
  ...
  describe('displays correct remaining time', () => {
    it('shows 90 seconds when at max', () => {
      render(<ReconnectCountdown countdown={90} maxSeconds={90} />);
      expect(screen.getByText('90')).toBeInTheDocument();
    });

    it('shows 0 seconds at minimum', () => {
      render(<ReconnectCountdown countdown={0} maxSeconds={90} />);
      expect(screen.getByText('0')).toBeInTheDocument();
    });

    it('shows middle values correctly', () => {
      render(<ReconnectCountdown countdown={42} maxSeconds={90} />);
  ...
  describe('shows progress circle', () => {
    it('renders SVG progress circle', () => {
      const { container } = render(
        <ReconnectCountdown countdown={45} maxSeconds={90} />
      );
  ...
  describe('renders animated loading dots', () => {
    it('renders three animated dots', () => {
      const { container } = render(
        <ReconnectCountdown countdown={30} maxSeconds={60} />
      );
  ...
  describe('accessibility', () => {
    it('displays countdown in visible text', () => {
      render(<ReconnectCountdown countdown={25} maxSeconds={60} />);
