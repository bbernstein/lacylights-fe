...
export default function AddCueDialog({
  ...
  }, [isOpen, currentCueNumber, currentSceneId, scenes, defaultFadeInTime, defaultFadeOutTime]);
      ...
      <div className="flex min-h-screen items-center justify-center px-4 pt-4 pb-20 text-center sm:block sm:p-0">
        ...
        <div className="inline-block align-bottom bg-white dark:bg-gray-800 rounded-lg px-4 pt-5 pb-4 text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full sm:p-6">
          <div>
            {/* Header */}
            <div className="mb-4">
              <h3 className="text-lg font-medium text-gray-900 dark:text-white">Add Cue</h3>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start">
                ...
                <div className="ml-3 text-sm">
                  <label htmlFor="create-copy" className="font-medium text-gray-700 dark:text-gray-300">
                    Create a copy of the scene
                  </label>
                  <p className="text-gray-500 dark:text-gray-400">
                    {createCopy
                      ? 'Recommended: Changes will not affect other cues using this scene'
                      : '⚠️ Warning: Changes will affect all cues using this scene'}
                  </p>
                </div>
              </div>
